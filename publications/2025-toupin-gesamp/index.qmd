...
This study reveals a steady increase in the number of citations to GESAMP publications in scholarly literature, with a notable rise since 2016.

These trends align with an increased awareness of climate change and ocean pollution. For instance, the UN's First World Ocean Assessment, released in 2017, exposed the degraded state of the oceans (UNESCO, 2017) and catalyzed national action. Canada, for example, launched a \$1.5 billion Oceans Protection Plan (OPP), the largest federal government investment in ocean protection (DFO Maritimes Region OPP Atlantic Hub, 2020). Such efforts around the globe may have spurred research drawing on GESAMP publications. As 2021 marked the beginning of the UN Decade of Ocean Science for Sustainable Development, GESAMP reports are likely to continue being needed and used.

GESAMP publications are cited in a range of journals, such as Marine Pollution Bulletin, Science of the Total Environment, and Environmental Pollution.

Moreover, mentions in policy documents indicate the relevance of GESAMP for governance and official bodies. Although it’s mostly UN organizations that draw from GESAMP, the expert group is also referenced in documents produced by the Canadian and United Kingdom governments, as well as by organizations such as the International Union for Conservation of Nature.

High levels of attention to specific GESAMP publications, such as *Sources, fate, and effects of microplastics in the marine environment* *(Parts 1 and 2)*, reiterate the importance of plastic pollution, especially microplastics, particularly in recent years.

Plastic pollution in the oceans has been a topic of high interest in recent years. As a result of the degradation of plastic components in ocean waters, microplastics pose several threats to marine life and human health through their ingestion and accumulation in the food chain. These reports were highly discussed in the news media upon publication. Overall, pollution, particularly from plastics, oil, or chemicals, is central to GESAMP's most cited and mentioned work. We also observe that GESAMP's most frequently mentioned work in policy documents and news media was published in recent years, a stark contrast to citations. This is likely the result of two phenomena: 1) the comparatively quicker pace at which public attention may accumulate to alternative formats, and 2) digital transformations that make relevant information more easily accessible, especially to policymakers. 
...
mpb<-openalexR::oa_fetch(entity = "works", source.id = "")
  


```

Some practical implication of our study is that it may
...
Further, availability bias in Overton and policy documents online may skew our dataset. Some countries have fewer policies available online than others or use references in the same ways, potentially excluding mentions of GESAMP.

Regarding news sources, databases do not typically distinguish between media, newswire, or news-feeding services.
